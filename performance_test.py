# -*- coding: utf-8 -*-
"""
Created on Sat Jul 23 11:55:29 2022
...
from visualization_data import get_input_sentence_dicts
...
for index, row in gold_std_df.iterrows():
    ...
    try:
        bert_database.legal_concepts[key]
...
for index, row in gold_std_df.iterrows():
    ...
    visual_dfs, input_dict = get_input_sentence_dicts(row['Query text'], bert_database)
